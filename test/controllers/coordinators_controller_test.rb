...
class CoordinatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coordinator" do
    assert_difference('Coordinator.count') do
      post coordinators_url, params: { coordinator: { firstname: @coordinator.firstname, lastname: @coordinator.lastname, title: @coordinator.title } }
    end
  ...
  test "should update coordinator" do
    patch coordinator_url(@coordinator), params: { coordinator: { firstname: @coordinator.firstname, lastname: @coordinator.lastname, title: @coordinator.title } }
